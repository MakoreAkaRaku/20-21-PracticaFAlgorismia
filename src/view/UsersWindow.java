...
/**
 * Classe que representa la finestra per a gestionar els usuaris de l'aplicaci√≥.
 * 
...
public class UsersWindow extends JFrame {
    ...
    public UsersWindow(UsersRepository users) {
        ...
        jTable1.getColumn("bot√≥").setCellRenderer(buttonRenderer);
    ...
    /**
     * Classe que representa la visualitzaci√≥ dels usuaris en forma de taula.
     */
    private class JTableUsersModel extends AbstractTableModel {

        private static final long serialVersionUID = 1L;
        private final String[] COLUMN_NAMES = new String[]{"ID", "Nom", "Mail", "Tipus usuari", "bot√≥"};
     ...
     * al bot√≥ d'un usuari concret de la taula.
     * 
     */
    ...
    private void jButton1MouseClicked(MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        text += "\n> Usuari amb mÈs accessos: " + users.findUserWithMaxAccess();
        text += "\n> Usuari amb mÈs partides guanyades: " + users.findUserWithMaxWins();
